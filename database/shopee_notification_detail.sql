...
CREATE TABLE `notification_detail` (
  `notification_detail_id` bigint NOT NULL AUTO_INCREMENT,
  `notification_id` bigint DEFAULT NULL,
  `subject` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `content` text,
...
-- Dump completed on 2022-12-27 21:18:49
